...
function Article() {
    ...
    const [hardCodeArticle, setHardCodeArticle] = useState({});

    useEffect(() => {
        setHardCodeArticle(hardCodeArticles.find((article) => article.id === Id.Id));
    }, []);
        ...
        <Container fluid>
            ...
            <Row id="article-title-row" style={{ marginLeft: "-12px", marginRight: "-12px" }}>
                ...
                <Col className="col-12 col-md-6 article-title-col" >
                    ...
                    <Header />
                    <h1>{hardCodeArticle.title}</h1>
                </Col>
                <Col className="col-12 col-md-6 article-title-col" >
                    <img src={hardCodeArticle.image_url} alt="Cat" className="article-title-image" />
                </Col>
            ...
            <Row className="d-flex">
                <Col className="col-12 col-md-8">
                    <div className="article-content">
                        <h4>written by {hardCodeArticle.user_id}</h4>
                        <hr style={{ width: "100%" }} />
                        <h4>{hardCodeArticle.text}</h4>

                        <img src={hardCodeArticle.image_url} alt="" className="inline-article-image"></img>
                        <h4>
