    ...
    return (
        <Container fluid>
            ...
            <Row id="article-title-row" style={{ marginLeft: "-12px", marginRight: "-12px" }}>
                ...
                <Col className="col-12 col-md-6 article-title-col" >
                    <img src="https://luczwyssig.github.io/TrumpImageRepo/TrumpTwitter.jpg" alt="Cat" className="article-title-image" />
                </Col>
                ...
                <Col className="col-12 col-md-8">
                    <div className="article-content">
                        ...
                        <h4>
                            ...
                            <img src="https://luczwyssig.github.io/TrumpImageRepo/TrumpTwitter.jpg" alt="" className="inline-article-image"></img>
